...
_2026-09-11T12:54:04Z · chain_valid=True_
...
| 4 | Нови понятия | constancy classes: {'MOVING': 9, 'POSITIVE_CONSTANT': 0, 'NEGATIVE_CONSTANT': 0, 'NEGATIVE_TREND': 1, 'UNCLASSIFIED': 6} | memory/constancy_bands_latest.json (the seed: constellation/constancy) | **SEED** |
...
| 13 | Разбиране срещу симулация | counterfactual probe 2026-09-11: 2 cases, TRACKS 0, INSENSITIVE 2, NOISE_DRIVEN 0, WRONG 0, SILENT 0; tracks_rate 0.0 | memory/counterfactual_probe_latest.json (core/counterfactual_probe.py, morning step) | **SEED** |
| 14 | Съзнание | — | open; no test | **—** |

**LIVE 1 · PARTIAL 7 · SEED 4 · — 2**
