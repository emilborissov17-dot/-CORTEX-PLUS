...
For a finite-label corpus (the positive control) EVERY row is SEEN and this is the verdict, not a memorisation check. For an open-ended corpus it remains the memorisation check.

| stratum | rows | effective n (pairs) | accuracy | 95% CI | verdict |
|---|---:|---:|---:|---|---|
| sig01_plain | 5 | 3 | 0.6000 | - | UNRESOLVABLE (3 distinct pairs < 30) |
| sig02_approved_with_impact | 11 | 8 | 1.0000 | - | UNRESOLVABLE (8 distinct pairs < 30) |

## SEEN — base (the same candidates, adapter disabled)

| stratum | rows | effective n (pairs) | accuracy | 95% CI | verdict |
|---|---:|---:|---:|---|---|
| sig01_plain | 5 | 3 | 0.4000 | - | UNRESOLVABLE (3 distinct pairs < 30) |
| sig02_approved_with_impact | 11 | 8 | 0.4545 | - | UNRESOLVABLE (8 distinct pairs < 30) |
...
|---|---|---|---|---|
| sig01_plain | 180 | 3.9541 | 2.6577 | +1.2964 |
| sig02_approved_with_impact | 27 | 2.1852 | 1.7397 | +0.4456 |
