...
The Telegram and GitHub actions live in publish_revisions.py so that the notary's
passage gate, which reads this module, never imports the supervisor or the
publisher (test_llm_text: core.notary must not reach core.llm_door).
