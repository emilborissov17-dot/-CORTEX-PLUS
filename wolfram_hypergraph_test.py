...
BASE_DIR = r"C:\Users\emilb\Desktop\AGI\CORTEX++_QWEN"
VISION_PATH = os.path.join(BASE_DIR, "civilization_vision.txt")  # беше data/...
...
# 4) Проста hypergraph структура в JSON (вместо graphbrain DB)
hyperedges = []
